    ...
    public class MemoryCacheManager : ICacheManager
    {
        ...
        public void RemoveByPattern(string pattern)
        {
            ...
            if (cacheEntriesFieldCollectionDefinition != null)
            {
                ...
                if (coherentStateValueCollection != null)
                {
                    ...
                    if (entriesCollectionValueCollection != null)
                    {
            ...
            if (cacheEntriesCollection != null)
            {
                ...
                {
                    var valueProp = cacheItem.GetType().GetProperty("Value");
                    if (valueProp != null)
                    {
                        ICacheEntry cacheItemValue = valueProp.GetValue(cacheItem, null);
